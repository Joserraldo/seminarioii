...
def draw_intersection(surface):
    ...
    pygame.draw.rect(surface, DARK_GRAY, (0, HEIGHT//2 - 100, WIDTH, 200))  
    pygame.draw.rect(surface, DARK_GRAY, (WIDTH//2 - 100, 0, 200, HEIGHT//2 + 100))  
    
    
    for i in range(0, WIDTH, 40):
        if abs(i - WIDTH//2) > 120:  
    ...
    for i in range(0, HEIGHT//2 + 100, 40):
        if i < HEIGHT//2 - 100 or i > HEIGHT//2:  
